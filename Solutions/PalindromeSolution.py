...
class TestPalindrome(unittest.TestCase):
    ...
    def test_epmty_string_plindrome(self):
        self.emptyvalue = ""
        self.assertVector = isPalindrome(self.emptyvalue)
        self.assertEquals(self.assertVector, True)

    def test_empty_string_with_whitespace_palindrome(self):
        self.whitespace = "        "
        self.assertVector = isPalindrome(self.whitespace)
        self.assertEquals(self.assertVector, True)
